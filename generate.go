...
//go:generate go run github.com/deepmap/oapi-codegen/v2/cmd/oapi-codegen@v2.1.0 --config ./server/api/nekos/v2/client.cfg.yaml -o ./server/api/nekos/v2/client.gen.go ./server/api/schema/nekos/v2.yaml
